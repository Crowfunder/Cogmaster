...
{
    [SlashCommand(CommandIds.TranslationsValue, "Get the property names that match the given value.")]
    public async Task ValueCommand([Summary(description: "Reverse search for property value, i.e \"Brandish\""), MinLength(3), MaxLength(69)] string value) =>
